...
/**
 * Servlet implementation class confirmboardList
 */
@WebServlet("/confirmList.bo")
public class confirmboardList extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public confirmboardList() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// 페이징 처리
		int listCount = cbs.getListCount(type, empNo);
		...
		list = cbs.selectList(currentPage, limit, type, empNo);
