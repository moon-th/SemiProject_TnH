            ...
            <div class="center">     
                <div class="container">
                    ...
                    <div class="row">
           				 ...
           				 <form id="updateForm" method="post" style="width: 1200px" enctype="multipart/form-data">
                            <table class="table table-striped"
                                ...
                                <tbody>
                                    ...
                                    <tr>
            							<td><textarea id="summernote" class="form-control" name="content"><%= n.getNcontent() %></textarea> 
            							</td> 
                                    </tr>           
                                </tbody>
