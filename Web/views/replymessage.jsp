...
<body class="a">
  <div class="mdl-layout mdl-js-layout mdl-layout--fixed-drawer">
      ...
      <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
          ...
          <br>
           ...
           + '<span class="mdl-chip__text">'+'<%=replydept%> <%=replyempname%>'+'</span>'
           + '<button type="button" class="mdl-chip__action" onclick="DeleteSendlist('+SendListIndex+');"><i class="material-icons">cancel</i></button>'
           + '</span>';
           SendListIndex++;
           receivelist.push('<%=replydept%> <%=replyempname%>') ; //목록에 이름을 추가
           receivelist2.push(<%=replynum%>); //??? 슈발어케한거지
	...
	<textarea name="textarea"
		class="jqte-test" id="jqte-test">
		=======================================================
		<br><br>
		<%=m.getEmpName()%>님이 <%=replyempname %>님에게 <%=replydate %> 에 받은 메세지 내용입니다.
		<br>
		<br>
		----------------------------------------------------------------------------
		<br><br>
  ...
  <div style="text-align: center;">
    ...
    <button class="mdl-button mdl-js-button mdl-button--raised mdl-button--colored" onclick="history.back();">
        취소
      </button>
  </div>
		<div class="footer">
