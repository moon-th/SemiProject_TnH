    ...
    <div class="mdl-layout__drawer">
      ...
      <nav class="mdl-navigation">
		...
		<%}
          ...
          <input id=filterno type=hidden value="" name=send_emp_no>
		  <input id=my_emp_no type=hidden value="" name="my_emp_no">
			</form>
			
			<script>
			function filterling(no){
				document.getElementById("filterno").value=no;
...
<!-- 아 이거 수정했음 아무튼수정함 -->
 ...
 <form id=deletefrm action="messagedelete.do">
  ...
  <script>
	var datalist = new Array();
     ...
     <%
    	  ...
    	  str+="<td>"+"<a href=msgRead.do?MessageId=<%=m.getMessage_Id()%>&my_emp_no=<%=request.getParameter("my_emp_no")%>><%=m.getSend_title()%>"+"</a></td>";
